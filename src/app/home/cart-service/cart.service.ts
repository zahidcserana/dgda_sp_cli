...
export class CartService {
  ...
  manualPurchase(data: any) {
    return this.http.post('orders/purchase/manual', data).toPromise();
  }
  ...
  saveOrderInlocalStorage(data) {
    localStorage.setItem('purchaseOrder', JSON.stringify(data));
  }

  savePurchaseItemInlocalStorage(data) {
    localStorage.setItem('purchaseItem', JSON.stringify(data));
  }
